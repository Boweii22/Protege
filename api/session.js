...
export default async function handler(request,response){
  ...
  try{
    ...
    const examUser=JSON.stringify({correctModel:body.topic.mustHit,studentBeliefs:body.beliefs});const exam=await trackedGenerate({userId:session.sub,lessonId:body.lessonId,kind:'blind_exam',system:examinerSystem,user:examUser,schema:examinerOutput,purpose:'examiner'});
